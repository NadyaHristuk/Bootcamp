let crypto = [
    ...
    },
    {
        ...
        "symbol": "DOGE",
        "rank": "44",
        "price_usd": "0.00531639",
        "price_btc": "0.00000056",
        "24h_volume_usd": "16575700.0",
        "market_cap_usd": "600866731.0",
        "available_supply": "113021567449",
        "total_supply": "113021567449",
        "max_supply": null,
        "percent_change_1h": "-1.14",
        "percent_change_24h": "-13.16",
        "percent_change_7d": "-28.54",
        "last_updated": "1517484242",
}

];

let cryptoName = crypto.map(item => item["name"]);
let cryptoPrice = crypto.map(item => item["price_usd"]);
